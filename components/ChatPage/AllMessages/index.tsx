    ...
    return (
        <div className={styles.messageBlock}>
            {messages?.map((message:any, i:any) => {
                ...
                return (
                    <>
                        { startPos && !messageDate.includes("undefined") && <div className={styles.messageDate}>{messageDate}</div> }
                        { showDate && !messageDate.includes("undefined") && <div className={styles.messageDate}>{messageDate}</div> }
