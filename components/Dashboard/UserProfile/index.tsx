...
const UserProfile = ({auth, updateUserInfoSubmit}:Props) => {
    ...
    return (
        <div className={styles.profileView}>
            ...
            {/* DP click popup */}
            <div 
                className={pictureUpdate ? styles.imageChangeDiv : styles.imageChangeDivHidden}
