...
export const DAILY_QUIZ_ELIGIBILITY_CHECK_SUCCESS: string = 'DAILY_QUIZ_ELIGIBILITY_CHECK_SUCCESS';
export const WEEKLY_QUIZ_ELIGIBILITY_CHECK_SUCCESS: string = '-WEEKLY_QUIZ_ELIGIBILITY_CHECK_SUCCESS';
...
export const SET_LOADING_CLEAR_SUPPORT_GROUP: string = 'SET_LOADING_CLEAR_SUPPORT_GROUP';
export const CLEAR_SUPPORT_GROUP_MESSAGES: string = 'CLEAR_SUPPORT_GROUP_MESSAGES';
export const CLEAR_SUPPORT_GROUP: string = 'CLEAR_SUPPORT_GROUP';
export const PAYMENT_METHOD_STATE_CHANGED: string = 'PAYMENT_METHOD_STATE_CHANGED';
export const SET_SUBSCRIPTION_STATUS: string = 'SET_SUBSCRIPTION_STATUS';
export const CLEAR_STRIPE_PAYMENT_METHODS: string = 'CLEAR_STRIPE_PAYMENT_METHODS';
export const SET_STRIPE_PAYMENT_METHODS_LOADING: string = 'SET_STRIPE_PAYMENT_METHODS_LOADING';
export const SET_STRIPE_PAYMENT_METHODS_SUCCESS: string = 'SET_STRIPE_PAYMENT_METHODS_SUCCESS';
export const SET_STRIPE_PAYMENT_METHODS_ERROR: string = 'SET_STRIPE_PAYMENT_METHODS_ERROR';
